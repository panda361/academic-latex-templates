...
\ie, this is an example of an introduction section.
\input{figures/example_figure.tex}

\input{tables/example_table.tex}

% Below is the original AAAI anonymous-submission template content.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\columnwidth]{example-image} % Keep the figure slightly narrower than the column.
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.8\textwidth]{example-image} % Keep the figure slightly narrower than the text width.
